...
def build_wikipedia_link(title):
    ...
    return f"https://en.wikipedia.org/wiki/{urllib.parse.quote(search_title.replace(' ', '_'))}"
...
demo_mode = st.sidebar.checkbox("🚀 Demo Mode (Works when API blocked)", value=True, 
